    ...
    <div class="flex flex-col justify-center py-20 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-4 text-sm leading-5 text-center text-gray-600 max-w">
                or, you can
                <a href="{{ route('register') }}" class="font-medium transition duration-150 ease-in-out text-gray-600 hover:text-gray-500 focus:outline-none focus:underline">
                    signup here
                </a>
            </p>
        </div>
                ...
                <form action="#" method="POST">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="text-sm leading-5">
                            <a href="{{ route('password.request') }}" class="font-medium transition duration-150 ease-in-out text-gray-600 hover:text-gray-500 focus:outline-none focus:underline">
                    ...
                    <div class="mt-6">
                        <span class="block w-full rounded-md shadow-sm">
                            <button type="submit" class="flex justify-center w-full px-4 py-2 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-gray-600 hover:bg-gray-500 focus:outline-none focus:border-gray-700 focus:shadow-outline-wave active:bg-gray-700">
                                Sign in
                            </button>
                        </span>
                    </div>
