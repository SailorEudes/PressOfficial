            ...
            <div class="pt-6 pb-6 space-y-6">
                ...
                <div>
                    <nav class="grid row-gap-8">
                        ...
                        <a href="{{ url('locale/it') }}" class="flex items-center px-8 py-3 space-x-3 transition duration-150 ease-in-out rounded-md hover:bg-gray-50">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                            </svg>
                            <div class="text-base font-medium leading-6 text-gray-900">
                                {{ __('messages.Menus.Italian') }}
                            </div>
                        </a>
            ...
            <div class="px-8 py-6 space-y-6">
                <div class="space-y-6">
                    ...
                    <p class="text-base font-medium leading-6 text-center text-gray-500">
                        {{ __('messages.Menus.existingCustomer') }}
