    ...
    <div class="p-8">
        ...
        @else
            ...
            @else
                ...
                <a href="{{ route('wave.settings', 'plans') }}" class="inline-flex self-start justify-center w-auto px-4 py-2 mt-5 text-sm font-medium text-white transition duration-150 ease-in-out border border-transparent rounded-md bg-gray-600 hover:bg-gray-500 focus:outline-none focus:border-wave-700 focus:shadow-outline-wave active:bg-gray-700">View Plans</a>
            @endif
        @endif
    </div>
</div>
