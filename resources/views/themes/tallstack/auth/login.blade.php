        ...
        <div class="px-4 py-8 bg-white border shadow border-gray-50 sm:rounded-lg sm:px-10">
            <form action="#" method="POST">
                ...
                <div>
                    ...
                    <label for="username" class="block text-sm font-medium leading-5 text-gray-700">{{ __('messages.Auth.username') }}</label>
                    ...
                    @endif
                    @else
                    <label for="email" class="block text-sm font-medium leading-5 text-gray-700">{{ __('messages.Auth.emailAddress') }}</label>
                    <div class="mt-1 rounded-md shadow-sm">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <div class="text-sm leading-5">
                        <a href="{{ route('password.request') }}" class="font-medium transition duration-150 ease-in-out text-gray-600 hover:text-gray-500 focus:outline-none focus:underline">
                            {{ __('messages.Auth.forgotPassword') }}
                        </a>
                    </div>
                </div>
